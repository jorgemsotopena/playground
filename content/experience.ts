...
const expereince : ExperienceContent = {
    ...
    job_title_intern: "Software Engineering Internship",
    job_description_intern: "Fusce sed tellus ultricies, porta dolor sit amet, scelerisque magna. Donec eget magna in justo rutrum pretium. Aliquam at vestibulum elit. Nunc viverra ante et pretium auctor. Nunc ac elit in justo accumsan dictum ut sed lectus. Suspendisse tincidunt aliquet eros a tristique.",
    personal_project_title: "Personal Website",
